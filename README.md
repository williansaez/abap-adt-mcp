...
Real sessions with the server and what they changed are recorded in [docs/FIELD-NOTES.md](docs/FIELD-NOTES.md); the live test plan is [docs/TESTPLAN.md](docs/TESTPLAN.md).
