...
export const TOOL_ROUTES: Record<HandlerKey, string[]> = {
  ...
  atc: ['atcCustomizing', 'atcCheckVariant', 'createAtcRun', 'atcWorklists', 'atcUsers',
    ...
    'atcQuickfixProposals', 'atcApplyQuickfix', 'atcDocumentation', 'atcSummary'],
  ...
  navigation: ['typeHierarchy', 'objectStructureElements', 'objectEnhancements', 'packageTree', 'whereUsed', 'cdsViewInfo', 'exportPackageSources'],
