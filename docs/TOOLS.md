...
Generated by `npm run tools:docs` from the built server (v0.3.1). Do not edit by hand; edit the tool definitions and regenerate.
...
| `source` | 11 | read/write/edit source, lock/unlock, pretty printer, revisions, text elements | yes |
| `objects` | 20 | search, structure, create/delete/activate objects, class components, hierarchy, enhancements | yes |
| `transports` | 18 | transport requests, diffs, release | yes |
| `analysis` | 14 | syntax check, completion, where-used, fixes, ABAP docs, runClass | yes |
...
## Objects & navigation (20) · toolset `objects`
...
## Syntax & code analysis (14) · toolset `analysis`
