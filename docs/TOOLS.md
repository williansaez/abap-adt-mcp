...
| `objects` | 26 | search by name and by content (text search, grep), structure, create/delete/activate objects, class components, hierarchy, enhancements | yes |
...
## Objects & navigation (26) · toolset `objects`
